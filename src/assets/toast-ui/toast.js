...
const toastMessage = (message, type, options = {}) => {
    ...
    setTimeout(() => {
        ...
        color var(--std-transition-duration) var(--std-transition-animation),
        background-color var(--std-transition-duration) var(--std-transition-animation),
        border var(--std-transition-duration) var(--std-transition-animation)`
